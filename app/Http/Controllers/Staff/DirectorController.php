...
class DirectorController extends Controller
{
    ...
    public function index()
    {
        //
        $data = Director::all();
        return view('staff.director.index', ['data' => $data]);
    }
    ...
    {
        //
        return view('staff.director.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        //Data Saved
        return redirect()->route('staff.director.index')->with('success', 'Director Added Successfully!');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('staff.director.show', ['data' => $data]);
    }
    ...
    public function edit(string $id)
    {
        //
        $data = Director::find($id);
        return view('staff.director.edit', ['data' => $data]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $data->save();
        //Data Saved
        return redirect()->route('staff.director.index')->with('success', 'Director Updated Successfully!');
    }
