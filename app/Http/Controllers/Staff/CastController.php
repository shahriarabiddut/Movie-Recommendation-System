...
class CastController extends Controller
{
    ...
    public function index()
    {
        //
        $data = Cast::all();
        return view('staff.cast.index', ['data' => $data]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data->save();
        //Data Saved
        return redirect()->route('staff.cast.index')->with('success', 'Cast Added Successfully!');
    }
    ...
    public function show(string $id)
    {
        //
        $data = Cast::find($id);
        return view('staff.cast.show', ['data' => $data]);
    }
    ...
    public function edit(string $id)
    {
        //
        $data = Cast::find($id);
        return view('staff.cast.edit', ['data' => $data]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $data->save();
        //Data Saved
        return redirect()->route('staff.cast.index')->with('success', 'Cast Updated Successfully!');
    }
